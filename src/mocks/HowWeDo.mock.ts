...
export const howWeDoMock: HowWeDoSectionProps = {
  ...
  description: `Nossa proposta de ensino coloca o aluno como protagonista. Incentivamos a <strong>autonomia</strong> e <strong> dedicação</strong> <strong> pessoal</strong> para o avanço no curso.<br/><br/>Nossas aulas, com conteúdos práticos e bem <strong> hands-on</strong>, preparam os alunos para a realidade do mercado de trabalho.<br/><br/> Além dos conteúdos específicos de cada curso, apresentamos as principais ferramentas Open Source exigidas pelo mercado e trabalhamos no desenvolvimento das softs-skills mais desejadas pelo mercado da tecnologia:  colaboração, <strong> comunicação</strong>,<strong> criatividade </strong> e <strong> flexibilidade</strong>.`,
  characteristicsList,
};
